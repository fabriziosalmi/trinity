...
def sample_e2e_content():
    ...
    return {
        "hero": {"title": "E2E Test Portfolio", "subtitle": "Integration Testing"},
        "body": {
            "sections": [
                {"title": "About", "content": "Software engineer with expertise in Python and ML."},
                {
                    "title": "Skills",
                    "content": "Python, Docker, Kubernetes, Machine Learning, CI/CD",
                },
...
def pathological_e2e_content():
    ...
    return {
        "hero": {"title": "Pathological Test", "subtitle": "Testing self-healing capabilities"},
        "body": {
            "sections": [

...
This guide covers everything you need to start using Trinity Core:
...
python -c "from src.trinity.components.brain import ContentEngine; print('OK')"
```
...
- [Neural-Symbolic Architecture](../1_Architecture/1.0_Neural_Symbolic.md) - Understand the 5-layer pipeline
